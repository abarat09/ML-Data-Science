...
workspace_name = "Aakriti_ML" # PLACEHOLDER
subscription_id = "afb6ac2c-d7e2-4e20-80e7-b216c765d922" # PLACEHOLDER
resource_group = "rg-az220" # PLACEHOLDER
experiment_name = "mslearn-bike-rental" # PLACEHOLDER
iteration = "0"  # PLACEHOLDER
run_id = "AutoML_84707285-f304-41bd-8de6-2078576ef649_0"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':None,'compute_target':'Aakriti-MLcompute','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':0.085,'experiment_timeout_minutes':30,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':30,'max_concurrent_iterations':2,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':None,'name':'mslearn-bike-rental','path':'./sample_projects/mslearn-bike-rental','primary_metric':'normalized_root_mean_squared_error','region':'eastus','resource_group':'rg-az220','subscription_id':'afb6ac2c-d7e2-4e20-80e7-b216c765d922','task_type':'regression','validation_size':None,'test_size':None,'vm_type':'STANDARD_DS11_V2','workspace_name':'Aakriti_ML','label_column_name':'rentals','save_mlflow':True,'enable_batch_run':True,'dataset_id':'91196f95-8433-4381-8568-1688a8905a5c'} # PLACEHOLDER
pipeline_spec = "{\"objects\":[{\"spec_class\":\"preproc\",\"class_name\":\"MaxAbsScaler\",\"module\":\"sklearn.preprocessing\",\"param_args\":[],\"param_kwargs\":{},\"prepared_kwargs\":{}},{\"spec_class\":\"sklearn\",\"class_name\":\"LightGBMRegressor\",\"module\":\"automl.client.core.common.model_wrappers\",\"param_args\":[],\"param_kwargs\":{\"min_data_in_leaf\":20},\"prepared_kwargs\":{}}],\"pipeline_id\":\"faf12f74cf9bbd358ca5525682c5030d36f7be7c\",\"module\":\"sklearn.pipeline\",\"class_name\":\"Pipeline\"}" # PLACEHOLDER
pipeline_id = "faf12f74cf9bbd358ca5525682c5030d36f7be7c" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"91196f95-8433-4381-8568-1688a8905a5c\"}}" # PLACEHOLDER
